...
def convert_file(raw_filename, file_location):
    ...
    template_file = 'template_files/Template Test Report Document FIX.xlsx'
    ...
    resized_image_path = resize_image('template_files/privy_logo.png', 408, 168 ) #412, 172)#305, 127)
